...
SYSTEM_PROMPT = (
    ...
    "DATA & STATISTICS QUESTIONS: If the user asks for counts, totals, or "
    "statistics (e.g. 'how many crimes', 'how many permits', 'how many licenses') "
    "and the context does not contain that specific number, ask a clarifying "
    "question to narrow down what they need — for example, what type of crime, "
    "what geographic unit (community area, ward, police beat), or what time "
    "period — before pointing them to the right city resource.\n\n"
